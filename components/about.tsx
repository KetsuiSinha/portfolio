...
const statements = [
  "I build scalable web applications with React and Next.js.",
  "Optimizing performance through lazy loading and smart rendering.",
  "AI-powered solutions that transform natural language to APIs.",
  "From concept to deployment with clean, maintainable code.",
  "Every interface tells a story through design and engineering.",
]
  ...
  return (
    <section ref={containerRef} className="relative py-32 overflow-hidden md:py-0">
      ...
      >
        ...
        <h2 className="font-sans text-3xl md:text-5xl font-light italic">Engineering Excellence</h2>
      </motion.div>
