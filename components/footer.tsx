...
export function Footer() {
  ...
  return (
    <footer className="relative">
      {/* Main CTA */}
      <motion.a
        href="mailto:nishchaykksinha@gmail.com"
        data-cursor-hover
      ...
      <div className="px-8 md:px-12 py-8 border-t border-white/10">
        <div className="flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex gap-8">
            {[
              { label: "LinkedIn", url: "https://www.linkedin.com/in/nishchay-sinha/" },
              { label: "GitHub", url: "https://github.com/KetsuiSinha" },
              { label: "LeetCode", url: "https://leetcode.com/u/AMMr93RKR0/" },
            ].map((link) => (
              <a
                key={link.label}
                href={link.url}
